...
public class WorldGeneratorStapeliaHirsuta implements IWorldGenerator
{
    @Override
    ...
    private void generateSurface(World world, Random random, int blockX, int blockZ)
    {
        ...
        if ((biome instanceof BiomeAfterLifeDesert) || (biome instanceof BiomeCactusFields) || (biome instanceof BiomeGenDesert))
        {
            for (int x = 0; x < 2; x++)
            {
                ...
                {
                    world.setBlock(i, j, k, MTJT.blackCallaLily.blockID, 0, 2);
                }
            }
        }
    }
