...
import morethantrees.treegen.WorldGenMushroom1Shroom;
...
public class BlockMushroom1Spore extends BlockFlower
{
    private Random               rand;
    public static final String[] WOOD_TYPES = new String[] { "mushroom" };
    
    public BlockMushroom1Spore(int i)
    {
        super(i);
        float f = 0.4F;
    ...
    {
        this.blockIcon = var1.registerIcon("MTJT:mushroom1");
    }
    ...
    public void generateTree(World world, int i, int j, int k, Random random, int l)
    {
        ...
        WorldGenMushroom1Shroom mushroom1 = new WorldGenMushroom1Shroom();
        
        if (!mushroom1.generate(world, random, i, j, k))
        {
    ...
    public void generate(World world, Random rand, int i, int j, int k)
    {
        world.setBlock(i, j, k, 0);
        WorldGenMushroom1Shroom mushroom1 = new WorldGenMushroom1Shroom();
        if (!mushroom1.generate(world, rand, i, j, k))
        {
            world.setBlock(i, j, k, this.blockID);
        }
