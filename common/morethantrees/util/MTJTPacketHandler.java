...
public class MTJTPacketHandler implements IPacketHandler
{
	...
	private void chicken(Packet250CustomPayload payload, Player player) 
	{
		...
		{	
			switch(data)
			{
				case 1: ((EntitySkyChicken)ent).isGoingUp = true;break;
				case 2: ((EntitySkyChicken)ent).isGoingDown = true;break;
				case 3: ((EntitySkyChicken)ent).isIdle = true;break;
				case 6: ((EntitySkyChicken)ent).isGoingUp = false;break;
				case 7: ((EntitySkyChicken)ent).isGoingDown = false;break;
				case 8: ((EntitySkyChicken)ent).isIdle = true;break;
			}	
		}
	}
	private void spider(Packet250CustomPayload payload, Player player) 
	{
		...
		{	
			switch(data)
			{
				case 4: ((EntityEasySpider)ent).isForward = true;break;
				case 5: ((EntityEasySpider)ent).isReverse = true;break;
				case 9: ((EntityEasySpider)ent).isForward = false;break;
				case 10: ((EntityEasySpider)ent).isReverse = false;break;
			}	
		}
	}
