...
{
    public BlockHardTorch(int par1)
    {
        super(par1, Material.circuits); //this makes it a torch like block
        this.setTickRandomly(true);
        this.setCreativeTab(MTJT.tabTreeBlocks); //this puts it in the decoration tabw
    }
    ...
    {
        this.blockIcon = par1IconRegister.registerIcon("MTJT:hardTorch");
    }
