...
import morethantrees.treegen.WorldGenLargeRoundTopShroom;
...
public class BlockLargeRoundTopSpore extends BlockFlower
{
	private Random rand;
	public static final String[] WOOD_TYPES = new String[] {"mushroom"};
    //private Icon[] blockIcon = new Icon[1];
	
	public BlockLargeRoundTopSpore(int i)
	{
		super(i);
		float f = 0.4F;
    ...
    {
        this.blockIcon = var1.registerIcon("MTJT:largeroundtop");
    }
	...
	public void generateTree(World world, int i, int j, int k, Random random, int l)
	{
		...
		WorldGenLargeRoundTopShroom largeroundtop = new WorldGenLargeRoundTopShroom();

		if (!largeroundtop.generate(world, random, i, j, k))
		{
	...
	public void generate(World world, Random rand, int i, int j, int k)
    {
		world.setBlock(i, j, k, 0);
		WorldGenLargeRoundTopShroom largeroundtop = new WorldGenLargeRoundTopShroom();
		if (!largeroundtop.generate(world, rand, i, j, k))
		{
			world.setBlock(i, j, k, this.blockID);
		}
