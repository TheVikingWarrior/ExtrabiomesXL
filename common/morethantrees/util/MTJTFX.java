...
public class MTJTFX
{
    ...
    public static EntityFX spawnParticle(String particleName, double par2, double par4, double par6, double par8, double par10, double par12)
    {
        if (mc != null && mc.renderViewEntity != null && mc.effectRenderer != null)
        {
            ...
            {
                if (particleName.equals("dandelion"))//if the name of the particle to be spawned equals test spawn our particle note the name here is the name that you use when you call spawn particle
                {
                    var21 = new DandelionFX(theWorld, par2, par4, par6, (float) par8, (float) par10, (float) par12);
                }
