...
public class BlockRedwoodLog extends Block
{
    ...
    {
        this.blockIcon[0] = var1.registerIcon("MTJT:redwoodLogTop");
        this.blockIcon[1] = var1.registerIcon("MTJT:redwoodLogSide");
    }
    ...
    {
        return MTJT.redwoodLog.blockID;
    }
            ...
            for (int var9 = -var7; var9 <= var7; ++var9)
            {
                for (int var10 = -var7; var10 <= var7; ++var10)
                {
                    for (int var11 = -var7; var11 <= var7; ++var11)
                    {
                        ...
                        if (var12 == MTJT.redwoodLeaves.blockID || var12 == MTJT.redwoodLeaves.blockID)
                        {
