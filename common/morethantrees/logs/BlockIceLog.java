...
{
	public static final String[] woodType = new String[] {"ice"};
    ...
    {
        this.blockIcon[0] = var1.registerIcon("MTJT:iceLogTop");
        this.blockIcon[1] = var1.registerIcon("MTJT:iceLogSide");
    }
            ...
            for (int var9 = -var7; var9 <= var7; ++var9)
            {
                for (int var10 = -var7; var10 <= var7; ++var10)
                {
                    for (int var11 = -var7; var11 <= var7; ++var11)
                    {
                        ...
                        if (var12 == MTJT.iceLeaves.blockID || var12 == MTJT.iceLeaves.blockID)
                        {
