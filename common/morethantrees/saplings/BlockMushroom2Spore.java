...
import morethantrees.treegen.WorldGenMushroom2Shroom;
...
public class BlockMushroom2Spore extends BlockFlower
{
    private Random               rand;
    public static final String[] WOOD_TYPES = new String[] { "mushroom" };
    
    public BlockMushroom2Spore(int i)
    {
        super(i);
        float f = 0.4F;
    ...
    {
        this.blockIcon = var1.registerIcon("MTJT:mushroom2");
    }
    ...
    public void generateTree(World world, int i, int j, int k, Random random, int l)
    {
        ...
        WorldGenMushroom2Shroom mushroom2 = new WorldGenMushroom2Shroom();
        
        if (!mushroom2.generate(world, random, i, j, k))
        {
    ...
    public void generate(World world, Random rand, int i, int j, int k)
    {
        world.setBlock(i, j, k, 0);
        WorldGenMushroom2Shroom mushroom2 = new WorldGenMushroom2Shroom();
        if (!mushroom2.generate(world, rand, i, j, k))
        {
            world.setBlock(i, j, k, this.blockID);
        }
