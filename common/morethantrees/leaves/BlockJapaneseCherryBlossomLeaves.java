...
public class BlockJapaneseCherryBlossomLeaves extends Block
{
    private int                  baseIndexInPNG;
    public static final String[] LEAF_TYPES = new String[] { "japaneseCherryBlossomLeaves" };
    int[]                        adjacentTreeBlocks;
    private Icon[]               cQ         = new Icon[2];
    
    public BlockJapaneseCherryBlossomLeaves(int par1)
    {
    ...
    {
        this.cQ[0] = par1IconRegister.registerIcon("MTJT:cherry_leaves");
        this.cQ[1] = par1IconRegister.registerIcon("MTJT:cherry_leaves");
    }
    ...
    public int idDropped(int par1, Random par2Random, int par3)
    {
        ...
        if (par2Random.nextInt(10) == 0)
            return MTJT.japanesecherryBlossomSapling.blockID;
        return MTJT.japanesecherryBlossomLeaves.blockID;
    }
    ...
    public void dropBlockAsItemWithChance(World par1World, int par2, int par3, int par4, int par5, float par6, int par7)
    {
        if (!par1World.isRemote)
        {
            ...
            {
                this.dropBlockAsItem_do(par1World, par2, par3, par4, new ItemStack(MTJT.japanesecherryBlossomSapling, 1, 0));
            }
        }
    }
