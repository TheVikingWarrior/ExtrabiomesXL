...
{
	public static final String[] woodType = new String[] {"giant"};
    ...
    public void registerIcons(IconRegister var1)
    {
        ...
        this.blockIcon[1] = var1.registerIcon("MTJT:giantLogSide");
    }
            ...
            for (int var9 = -var7; var9 <= var7; ++var9)
            {
                for (int var10 = -var7; var10 <= var7; ++var10)
                {
                    for (int var11 = -var7; var11 <= var7; ++var11)
                    {
                        ...
                        if (var12 == MTJT.giantLeaves.blockID || var12 == MTJT.giantLeaves.blockID)
                        {
