...
{
	public static final String[] woodType = new String[] {"cherryBlossom"};
    ...
    {
        this.blockIcon[0] = var1.registerIcon("MTJT:cherry_top");
        this.blockIcon[1] = var1.registerIcon("MTJT:cherry_side");
    }
    ...
    {
        return MTJT.japanesecherryBlossomLog.blockID;
    }
            ...
            for (int var9 = -var7; var9 <= var7; ++var9)
            {
                for (int var10 = -var7; var10 <= var7; ++var10)
                {
                    for (int var11 = -var7; var11 <= var7; ++var11)
                    {
                        ...
                        if (var12 == MTJT.japanesecherryBlossomLeaves.blockID || var12 == MTJT.japanesecherryBlossomLeaves.blockID)
                        {
