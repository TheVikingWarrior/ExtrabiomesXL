...
public class BlockCantaloupeLeaves extends BlockLeavesBase implements IShearable
{
	...
	public static final String[] LEAF_TYPES = { "cantaloupe" };
	int[] adjacentTreeBlocks;
	private Icon[] cQ = new Icon[2];

	public BlockCantaloupeLeaves(int par1)
	{
	...
	{
		this.cQ[0] = par1IconRegister.registerIcon("MTJT:cantaloupeLeaves");
		this.cQ[1] = par1IconRegister.registerIcon("MTJT:cantaloupeLeaves");
	}
			...
			for (int var9 = -var7; var9 <= var7; var9++)
			{
				for (int var10 = -var7; var10 <= var7; var10++)
				{
					for (int var11 = -var7; var11 <= var7; var11++)
					{
						...
						if (var12 == MTJT.cantaloupeLeaves.blockID)
						{
					...
					for (int var12 = -var7; var12 <= var7; var12++)
					{
						for (int var13 = -var7; var13 <= var7; var13++)
						{
							for (int var14 = -var7; var14 <= var7; var14++)
							{
								...
								if (var15 == MTJT.cantaloupeLog.blockID)
								{
									this.adjacentTreeBlocks[((var12 + var11) * var10 + (var13 + var11) * var9 + var14 + var11)] = 0;
								}
								else if (var15 == MTJT.cantaloupeLeaves.blockID)
								{
	...
	public int idDropped(int par1, Random par2Random, int par3)
	{
		if(par2Random.nextInt(10) == 0)
            		return MTJT.cantaloupeSapling.blockID;
            		return MTJT.cantaloupe.itemID;
	}
