...
public class BlockBlackWoodSlab extends BlockHalfSlab
{
    ...
    {
        if (par1World.getBlockId(par2, par3 - 1, par4) == MTJT.blackWoodSingleSlab.blockID)
        {
            par1World.setBlock(par2, par3, par4, 0);
            par1World.setBlock(par2, par3 - 1, par4, MTJT.blackWoodDoubleSlab.blockID);
        }
        if (par1World.getBlockId(par2, par3 + 1, par4) == MTJT.blackWoodSingleSlab.blockID)
        {
            par1World.setBlock(par2, par3, par4, 0);
    ...
    {
        return new ItemStack(MTJT.blackWoodSingleSlab.blockID, 2, par1 & 7);
    }
    ...
    {
        if (par1 != MTJT.blackWoodDoubleSlab.blockID)
        {
