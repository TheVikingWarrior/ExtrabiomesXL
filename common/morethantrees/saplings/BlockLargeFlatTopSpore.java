...
import morethantrees.treegen.WorldGenLargeFlatTopShroom;
...
public class BlockLargeFlatTopSpore extends BlockFlower
{
    private Random               rand;
    ...
    public BlockLargeFlatTopSpore(int i)
    {
        super(i);
        float f = 0.4F;
    ...
    {
        this.blockIcon = var1.registerIcon("MTJT:largeflattop");
    }
    ...
    public void generateTree(World world, int i, int j, int k, Random random, int l)
    {
        ...
        WorldGenLargeFlatTopShroom largeflattop = new WorldGenLargeFlatTopShroom();
        
        if (!largeflattop.generate(world, random, i, j, k))
        {
    ...
    public void generate(World world, Random rand, int i, int j, int k)
    {
        world.setBlock(i, j, k, 0);
        WorldGenLargeFlatTopShroom largeflattop = new WorldGenLargeFlatTopShroom();
        if (!largeflattop.generate(world, rand, i, j, k))
        {
            world.setBlock(i, j, k, this.blockID);
        }
