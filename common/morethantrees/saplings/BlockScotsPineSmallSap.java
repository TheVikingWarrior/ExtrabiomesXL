...
public class BlockScotsPineSmallSap extends BlockFlower
{
	private Random rand;
	public static final String[] WOOD_TYPES = new String[] {"scotspine"};
    
	public BlockScotsPineSmallSap(int i)
	{
		super(i);
		float f = 0.4F;
	...
	public void generateTree(World world, int i, int j, int k, Random random, int l)
	{
		...
		WorldGenScotsPineSmallTree scotspinesmall = new WorldGenScotsPineSmallTree();

		if (!scotspinesmall.generate(world, random, i, j, k))
		{
	...
	public void generate(World world, Random rand, int i, int j, int k)
    {
		world.setBlock(i, j, k, 0);
		WorldGenScotsPineSmallTree scotspinesmall = new WorldGenScotsPineSmallTree();
		if (!scotspinesmall.generate(world, rand, i, j, k))
		{
			world.setBlock(i, j, k, this.blockID);
		}
