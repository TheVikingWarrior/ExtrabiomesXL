...
{
    public static final String[] woodType  = new String[] { "painLog" };
    ...
    {
        this.blockIcon[0] = var1.registerIcon("MTJT:painLogTop");
        this.blockIcon[1] = var1.registerIcon("MTJT:painLogSide");
    }
            ...
            for (int var9 = -var7; var9 <= var7; ++var9)
            {
                for (int var10 = -var7; var10 <= var7; ++var10)
                {
                    for (int var11 = -var7; var11 <= var7; ++var11)
                    {
                        ...
                        if (var12 == MTJT.painLeaves.blockID || var12 == MTJT.painLeaves.blockID)
                        {
    ...
    public void onEntityCollidedWithBlock(World par1World, int par2, int par3, int par4, Entity par5Entity)
    {
        ...
        {
            ((EntityLiving) par5Entity).addPotionEffect(new PotionEffect(Potion.hunger.getId(), 100, 1));
        }
    }
