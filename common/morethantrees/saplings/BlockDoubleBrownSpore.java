...
import morethantrees.treegen.WorldGenDoubleBrownShroom;
...
public class BlockDoubleBrownSpore extends BlockFlower
{
    private Random               rand;
    ...
    public BlockDoubleBrownSpore(int i)
    {
        super(i);
        float f = 0.4F;
    ...
    {
        this.blockIcon = var1.registerIcon("MTJT:doublebrown");
    }
    ...
    public void generateTree(World world, int i, int j, int k, Random random, int l)
    {
        ...
        WorldGenDoubleBrownShroom brownshroom = new WorldGenDoubleBrownShroom();
        
        if (!brownshroom.generate(world, random, i, j, k))
        {
    ...
    public void generate(World world, Random rand, int i, int j, int k)
    {
        world.setBlock(i, j, k, 0);
        WorldGenDoubleBrownShroom brownshroom = new WorldGenDoubleBrownShroom();
        if (!brownshroom.generate(world, rand, i, j, k))
        {
            world.setBlock(i, j, k, this.blockID);
        }
