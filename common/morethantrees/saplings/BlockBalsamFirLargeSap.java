...
import morethantrees.treegen.WorldGenBalsamFirLargeTree;
...
public class BlockBalsamFirLargeSap extends BlockFlower
{
	private Random rand;
	public static final String[] WOOD_TYPES = new String[] {"balsamfir"};
    //private Icon[] blockIcon = new Icon[1];
    
    public BlockBalsamFirLargeSap(int par1)
    {
    	super(par1);
    	float f = 0.4F;
    ...
    */
    ...
    {
    	this.blockIcon = var1.registerIcon("MTJT:BalsamFir");
    }
    ...
    */
    ...
    public void generateTree(World world, int i, int j, int k, Random random, int l)
	{
		...
		WorldGenBalsamFirLargeTree balsamfirlarge = new WorldGenBalsamFirLargeTree();

		if (!balsamfirlarge.generate(world, random, i, j, k))
		{
	...
	public void generate(World world, Random rand, int i, int j, int k)
    {
		world.setBlock(i, j, k, 0);
		WorldGenBalsamFirLargeTree balsamfirlarge = new WorldGenBalsamFirLargeTree();
		if (!balsamfirlarge.generate(world, rand, i, j, k))
		{
			world.setBlock(i, j, k, this.blockID);
		}
