...
public class BlockRandomBrownCupSpore extends BlockFlower
{
	private Random rand;
	public static final String[] WOOD_TYPES = new String[] {"mushroom"};
    //private Icon[] blockIcon = new Icon[1];
	
	public BlockRandomBrownCupSpore(int i)
	{
		super(i);
		float f = 0.4F;
    ...
    {
        this.blockIcon = var1.registerIcon("MTJT:randombrowncup");
    }
	...
	public void generate(World world, Random rand, int i, int j, int k)
    {
		world.setBlock(i, j, k, 0);
		WorldGenRandomBrownCupShroom browncupshroom = new WorldGenRandomBrownCupShroom();
		if (!browncupshroom.generate(world, rand, i, j, k))
		{
			world.setBlock(i, j, k, this.blockID);
		}
