...
public class EntityPunSheep extends EntityAnimal
{
    ...
    public EntityPunSheep(World par1World)
    {
        ...
        texture = "/mods/MTJT/textures/mobs/punsheep.png";
        setSize(0.9F, 1.3F);
        float f = 0.23F;
    ...
    public boolean attackEntityFrom(DamageSource damagesource, int i)
    {
        ...
        if (!getSheared() && (entity instanceof EntityPlayer) && MTJT.punchSheep)
        {
            setSheared(true);
    ...
    /**
     * This function applies the benefits of growing back wool and faster growing up to the acting entity. (This function is used in the
     * AIEatGrass)
     */
