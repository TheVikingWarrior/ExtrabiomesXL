...
{
	public static final String[] woodType = new String[] {"wolf"};
    ...
    {
        this.blockIcon[0] = var1.registerIcon("MTJT:wolfLogTop");
        this.blockIcon[1] = var1.registerIcon("MTJT:wolfLogSide");
    }
            ...
            for (int var9 = -var7; var9 <= var7; ++var9)
            {
                for (int var10 = -var7; var10 <= var7; ++var10)
                {
                    for (int var11 = -var7; var11 <= var7; ++var11)
                    {
                        ...
                        if (var12 == MTJT.wolfLeaves.blockID || var12 == MTJT.wolfLeaves.blockID)
                        {
