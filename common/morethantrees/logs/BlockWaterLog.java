...
{
    public static final String[] woodType  = new String[] { "water" };
    ...
    {
        this.blockIcon[0] = var1.registerIcon("MTJT:waterLogTop");
        this.blockIcon[1] = var1.registerIcon("MTJT:waterLogSide");
    }
            ...
            for (int var9 = -var7; var9 <= var7; ++var9)
            {
                for (int var10 = -var7; var10 <= var7; ++var10)
                {
                    for (int var11 = -var7; var11 <= var7; ++var11)
                    {
                        ...
                        if (var12 == MTJT.waterLeaves.blockID || var12 == MTJT.waterLeaves.blockID)
                        {
