...
{
    public static final String[] woodType  = new String[] { "jungle" };
    private Icon[]               blockIcon = new Icon[2];
    
    public BlockJungleWood(int par1)
    {
    ...
    {
        this.blockIcon[0] = var1.registerIcon("MTJT:tree_top");
        this.blockIcon[1] = var1.registerIcon("MTJT:tree_side");
    }
    ...
    {
        return MTJT.jungleWood.blockID;
    }
            ...
            for (int var9 = -var7; var9 <= var7; ++var9)
            {
                for (int var10 = -var7; var10 <= var7; ++var10)
                {
                    for (int var11 = -var7; var11 <= var7; ++var11)
                    {
                        ...
                        if (var12 == MTJT.jungleLeaves.blockID || var12 == MTJT.jungleLeaves.blockID)
                        {
