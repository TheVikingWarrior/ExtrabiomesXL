...
public class BlockSmokinLeaves extends BlockLeavesBase implements IShearable
{
	...
	public static final String[] LEAF_TYPES = { "smokin" };
	int[] adjacentTreeBlocks;
	private Icon[] cQ = new Icon[2];

	public BlockSmokinLeaves(int par1)
	{
	...
	{
		this.cQ[0] = par1IconRegister.registerIcon("MTJT:smokinLeaves");
		this.cQ[1] = par1IconRegister.registerIcon("MTJT:smokinLeaves");
	}
			...
			for (int var9 = -var7; var9 <= var7; var9++)
			{
				for (int var10 = -var7; var10 <= var7; var10++)
				{
					for (int var11 = -var7; var11 <= var7; var11++)
					{
						...
						if (var12 == MTJT.smokinLeaves.blockID)
						{
					...
					for (int var12 = -var7; var12 <= var7; var12++)
					{
						for (int var13 = -var7; var13 <= var7; var13++)
						{
							for (int var14 = -var7; var14 <= var7; var14++)
							{
								...
								if (var15 == MTJT.smokinLog.blockID)
								{
									this.adjacentTreeBlocks[((var12 + var11) * var10 + (var13 + var11) * var9 + var14 + var11)] = 0;
								}
								else if (var15 == MTJT.smokinLeaves.blockID)
								{
	...
	public int idDropped(int par1, Random par2Random, int par3)
	{
		if(par2Random.nextInt(10) == 0)
            		return MTJT.smokinSapling.blockID;
            		return MTJT.tntStick.itemID;
	}
