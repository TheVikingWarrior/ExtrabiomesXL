...
import morethantrees.treegen.WorldGenCalifornianRedFirSmallTree;
...
public class BlockCalifornianRedFirSmallSap extends BlockFlower
{
    private Random               rand;
    ...
    public BlockCalifornianRedFirSmallSap(int i)
    {
        super(i);
        float f = 0.4F;
    ...
    public void generateTree(World world, int i, int j, int k, Random random, int l)
    {
        ...
        WorldGenCalifornianRedFirSmallTree redfirsmall = new WorldGenCalifornianRedFirSmallTree();
        
        if (!redfirsmall.generate(world, random, i, j, k))
        {
    ...
    public void generate(World world, Random rand, int i, int j, int k)
    {
        world.setBlock(i, j, k, 0);
        WorldGenCalifornianRedFirSmallTree redfirsmall = new WorldGenCalifornianRedFirSmallTree();
        if (!redfirsmall.generate(world, rand, i, j, k))
        {
            world.setBlock(i, j, k, this.blockID);
        }
