...
import morethantrees.treegen.WorldGenCalifornianRedFirLargeTree;
...
public class BlockCalifornianRedFirLargeSap extends BlockFlower
{
	private Random rand;
	public static final String[] WOOD_TYPES = new String[] {"redfir"};
    //private Icon[] blockIcon = new Icon[1];
	
	public BlockCalifornianRedFirLargeSap(int i)
	{
		super(i);
		float f = 0.4F;
    ...
    {
        this.blockIcon = var1.registerIcon("MTJT:CaliforniaRedFir");
    }
	...
	public void generateTree(World world, int i, int j, int k, Random random, int l)
	{
		...
		WorldGenCalifornianRedFirLargeTree redfirlarge = new WorldGenCalifornianRedFirLargeTree();

		if (!redfirlarge.generate(world, random, i, j, k))
		{
	...
	public void generate(World world, Random rand, int i, int j, int k)
    {
		world.setBlock(i, j, k, 0);
		WorldGenCalifornianRedFirLargeTree redfirlarge = new WorldGenCalifornianRedFirLargeTree();
		if (!redfirlarge.generate(world, rand, i, j, k))
		{
			world.setBlock(i, j, k, this.blockID);
		}
