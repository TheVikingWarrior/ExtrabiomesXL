...
{
	public static final String[] woodType = new String[] {"life"};
    ...
    {
        this.blockIcon[0] = var1.registerIcon("MTJT:lifeLogTop");
        this.blockIcon[1] = var1.registerIcon("MTJT:lifeLogSide");
    }
            ...
            for (int var9 = -var7; var9 <= var7; ++var9)
            {
                for (int var10 = -var7; var10 <= var7; ++var10)
                {
                    for (int var11 = -var7; var11 <= var7; ++var11)
                    {
                        ...
                        if (var12 == MTJT.lifeLeaves.blockID || var12 == MTJT.lifeLeaves.blockID)
                        {
	...
	public void onEntityCollidedWithBlock(World par1World, int par2, int par3, int par4, Entity par5Entity)
    {
    		 ...
    		 {
    		 ((EntityLiving) par5Entity).addPotionEffect(new PotionEffect(Potion.regeneration.getId(), 100,2));
    		 }
    }
