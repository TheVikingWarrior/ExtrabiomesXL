...
import morethantrees.treegen.WorldGenTallBrownMushroomShroom;
...
public class BlockTallBrownMushroomSpore extends BlockFlower
{
	private Random rand;
	public static final String[] WOOD_TYPES = new String[] {"mushroom"};
    
	public BlockTallBrownMushroomSpore(int i)
	{
		super(i);
		float f = 0.4F;
    ...
    {
        this.blockIcon = var1.registerIcon("MTJT:tallbrownspore");
    }
	...
	public void generateTree(World world, int i, int j, int k, Random random, int l)
	{
		...
		WorldGenTallBrownMushroomShroom tbms = new WorldGenTallBrownMushroomShroom();

		if (!tbms.generate(world, random, i, j, k))
		{
	...
	public void generate(World world, Random rand, int i, int j, int k)
    {
		world.setBlock(i, j, k, 0);
		WorldGenTallBrownMushroomShroom tbms = new WorldGenTallBrownMushroomShroom();
		if (!tbms.generate(world, rand, i, j, k))
		{
			world.setBlock(i, j, k, this.blockID);
		}
